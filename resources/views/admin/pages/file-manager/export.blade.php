                ...
                <div class="card-body pb-0">
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-nowrap">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6 active" href="{{ route('fm_export') }}">Экспорт</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
                ...
                <div class="card-body">
                    ...
                    <form class="form" id="kt_file_manager_settings">
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-9">
                                ...
                                <select name="language" aria-label="Select a Language" data-control="select2" data-placeholder="Укажите данные для выгрузки" class="form-select mb-2">
                                    ...
                                    <option value="payments">Показания</option>
                                </select>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-3 d-flex align-items-center">
                                <!--begin::Label-->
                                <label class="fs-6 fw-bold">Объекты:</label>
                                <!--end::Label-->
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-3 d-flex align-items-center">
                                <!--begin::Label-->
                                <label class="fs-6 fw-bold">Период:</label>
                                <!--end::Label-->
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                        ...
                        <div class="row mt-12">
                            <div class="col-md-9 offset-md-3">
                                ...
                                <button type="button" class="btn btn-primary" id="kt_file_manager_settings_submit">
                                    <span class="indicator-label">Скачать</span>
