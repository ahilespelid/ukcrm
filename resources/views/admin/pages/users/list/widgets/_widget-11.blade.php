    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            <a href="#" class="btn btn-sm btn-light-primary">
                {!! AdminController::getSvgIcon("icons/duotune/arrows/arr075.svg", "svg-icon-2") !!}
                New Member
            </a>
        </div>
    </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-5">
                                        <img src="{{ asset($row['product']['image']) }}" class="" alt=""/>
                                    </div>
                            ...
                            <td class="text-end">
                                <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    {!! AdminController::getSvgIcon("icons/duotune/general/gen019.svg", "svg-icon-3") !!}
                                </a>

                                <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    {!! AdminController::getSvgIcon("icons/duotune/art/art005.svg", "svg-icon-3") !!}
                                </a>

                                <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                    {!! AdminController::getSvgIcon("icons/duotune/general/gen027.svg", "svg-icon-3") !!}
                                </a>
                            </td>
                        </tr>
                    @endforeach
